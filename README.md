...
## Environments
- Preview: https://main--xwalk_eds-universal-editor--gspann-content.aem.page/
- Live: https://main--xwalk_eds-universal-editor--gspann-content.aem.live/
...
1. Open the `xwalk_eds-universal-editor` directory in your favorite IDE and start coding :)
